        ...
        builder: (context, child) => Stack(
          children: <Widget>[
            ClipPath(
              child: Container(
                decoration: BoxDecoration(
                  color: AliveAndKickingTheme.nearlyDarkBlue.withOpacity(0.5),
                  ...
                  gradient: LinearGradient(
                    colors: [
                      AliveAndKickingTheme.nearlyDarkBlue.withOpacity(0.2),
                      AliveAndKickingTheme.nearlyDarkBlue.withOpacity(0.5)
                    ],
            ...
            ClipPath(
              child: Container(
                decoration: BoxDecoration(
                  color: AliveAndKickingTheme.nearlyDarkBlue,
                  gradient: LinearGradient(
                    colors: [
                      AliveAndKickingTheme.nearlyDarkBlue.withOpacity(0.4),
                      AliveAndKickingTheme.nearlyDarkBlue
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Positioned(
              ...
              child: ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: AliveAndKickingTheme.white.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: AliveAndKickingTheme.white.withOpacity(
